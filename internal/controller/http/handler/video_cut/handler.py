...
class VideoCutController(interface.IVideoCutController):
    ...
    async def create_vizard_video_cuts(
        ...
        with self.tracer.start_as_current_span(
            ...
            try:
                await self.video_cut_service.create_vizard_video_cuts(body.project_id)
    ...
    async def download_video_cut(
        ...
        with self.tracer.start_as_current_span(
            ...
            try:
                ...
                video_io, content_type = await self.video_cut_service.download_video_cut(video_cut_id)
